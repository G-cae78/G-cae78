...
| Domain | Stack / Focus |
|--------|--------------|
| 🤖 **ML & AI** | Python · PyTorch · LLMs · Clustering · RAG |
| ☁️ **Cloud** | AWS · Cloudflare · Docker · Solutions Architecture |
| 🔐 **Cybersecurity** | Honeypots · WAF · Threat clustering · MITRE D3FEND |
| 🎮 **Game Dev** | Unity · C# · ShaderLab · Simulation |
| 🌐 **Full Stack** | TypeScript · React · Vue · Java · Node |
...
### 🍯 Honey In The Cloud
Cloud-hosted honeypot comparing **Cloudflare vs BunnyCDN** security. Features an **HDBSCAN/UMAP** ML clustering pipeline and an agentic **LLM layer** with RAG over MITRE D3FEND.
...
### 🎮 Boy-Racer
Car racing game built in the **Unity engine** with ShaderLab visuals and custom physics handling.

`Unity` `C#` `ShaderLab` `Game Dev`
...
### 🎵 NotSpotify
Full-stack music streaming clone — frontend in JavaScript, backend in Java, built for scale.
...
### 🐚 Bashbook
A user-friendly **social networking interface** written entirely in BashScript — pipes, shell, no framework needed.
...
### 🕹️ Asteroids — Unity
Classic Asteroids rebuilt in Unity with modern ShaderLab rendering and polished game feel.
...
### 🌐 L1mitless Website
Personal brand website built in **Vue** — home of the L1mitless creative universe.
